...
class BamlSyncClient:
    ...
    def ExtractDropOffPackageReceiptFromImage(
      ...
      return cast(types.DropOffPackageReceipt, raw.cast_to(types, types))
...
class BamlStreamClient:
    ...
    def ExtractDropOffPackageReceiptFromImage(
      ...
      return baml_py.BamlSyncStream[partial_types.DropOffPackageReceipt, types.DropOffPackageReceipt](
        raw,
        lambda x: cast(partial_types.DropOffPackageReceipt, x.cast_to(types, partial_types)),
        lambda x: cast(types.DropOffPackageReceipt, x.cast_to(types, types)),
        self.__ctx_manager.get(),
      )
